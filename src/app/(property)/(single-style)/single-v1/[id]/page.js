...
const SingleV1 = ({ params }) => {
  ...
  useEffect(() => {
    getPropertyById().then((result) => {
      if (result?.data) {
        const { data } = result.data;
        setProperty(data);
      } else {
        console.error("Failed with fetching data");
      }
    });
  }, []);
  ...
  const getPropertyById = async () => {
    const response = await axios.get(
      `http://localhost:8090/realestate/property/${id}`
    );
    ...
    <>
      ...
      <section className="pt60 pb90 bgc-f7">
        <div className="container">
          <div className="row">
            <PropertyHeader id={params.id} property={property} />
          </div>
          {/* End .row */}

          <div className="row mb30 mt30">
            <PropertyGallery id={params.id} property={property} />
          </div>
          {/* End .row */}
          ...
          <div className="row wrap">
            <div className="col-lg-8">
              ...
              <div className="ps-widget bgc-white bdrs12 default-box-shadow2 p30 mb30 overflow-hidden position-relative">
                ...
                <div className="row">
                  <PropertyAddress address={property?.location} />
                </div>
              </div>
              {/* End .ps-widget */}
